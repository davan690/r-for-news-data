...
These coordinates have been produced in cooperation wiht another project with the Library, _Living with Machines_. We used smart annotations to quickly correct and train 
```{r}
