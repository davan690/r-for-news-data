...
## Why R?
This is a handbook made _with_ R, and _using_ R, but it is not really primarily _about_ R. I wanted to show some techniques. It should be readable by anyone, but it's possible bits will not be so easy to follow.
